...
public class constant {
    ...
    public static final String hrm_username = "Admin";

    public static final String hrm_password = "admin123";
    ...
    public static final String SheetName = "Student";

    public static final String URI_API_SAMPLE = "https://reqres.in";

    public static final String apiKey = "";
    
    public static final String API_REQRES_URL = "https://reqres.in";
